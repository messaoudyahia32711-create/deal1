...
export type MerchantTab = 'overview' | 'products' | 'orders' | 'wallet' | 'reviews' | 'chat' | 'profile'
export type ProviderTab = 'overview' | 'services' | 'bookings' | 'wallet' | 'reviews' | 'chat' | 'profile'
export type CustomerTab = 'overview' | 'cart' | 'orders' | 'favorites' | 'chat' | 'reviews' | 'profile'
export type AdminTab = 'overview' | 'users' | 'commissions' | 'categories' | 'complaints' | 'settings' | 'chat' | 'profile'
export type RentalProviderTab = 'overview' | 'rentals' | 'bookings' | 'wallet' | 'reviews' | 'chat' | 'profile'
