...
export const translations = {
  ar: {
    ...
    suspended: 'معلّق',
    // Filters
    search: 'ابحث عن منتج، خدمة أو معدة...',
    ...
    friday: 'الجمعة',
    // Rental
    rentals: 'كراء المعدات',
    rental: 'كراء',
    rentalProvider: 'مؤجر المعدات',
    rentNow: 'استأجر الآن',
    dailyRate: 'اليومي',
    weeklyRate: 'الأسبوعي',
    monthlyRate: 'الشهري',
    deposit: 'الضمان',
    minRentalDays: 'أقل مدة',
    maxRentalDays: 'أقصى مدة',
    rentalDays: 'أيام الإيجار',
    deliveryAvailable: 'توصيل متاح',
    totalDays: 'إجمالي الأيام',
    rentalPeriod: 'فترة الإيجار',
    addRental: 'إضافة معدة',
    editRental: 'تعديل المعدة',
    rentalPanel: 'لوحة مؤجر المعدات',
    equipment: 'معدة',
    completedRentals: 'إيجارات منجزة',
    registerAsRental: 'سجّل كمؤجر معدات',
    offerRentals: 'قدّم معداتك للكراء',
    searchRental: 'ابحث عن معدة للكراء...',
    perDay: '/يوم',
    perWeek: '/أسبوع',
    perMonth: '/شهر',
    // Profile Edit
  ...
  fr: {
    ...
    suspended: 'Suspendu',
    // Filters
    search: 'Rechercher un produit, service ou location...',
    ...
    friday: 'Vendredi',
    // Rental
    rentals: "Location d'équipements",
    rental: 'Location',
    rentalProvider: "Loueur d'équipements",
    rentNow: 'Louer maintenant',
    dailyRate: 'Journalier',
    weeklyRate: 'Hebdomadaire',
    monthlyRate: 'Mensuel',
    deposit: 'Caution',
    minRentalDays: 'Durée min.',
    maxRentalDays: 'Durée max.',
    rentalDays: 'Jours de location',
    deliveryAvailable: 'Livraison disponible',
    totalDays: 'Total jours',
    rentalPeriod: 'Période de location',
    addRental: 'Ajouter un équipement',
    editRental: "Modifier l'équipement",
    rentalPanel: 'Panneau loueur',
    equipment: 'Équipement',
    completedRentals: 'Locations complétées',
    registerAsRental: 'Inscrivez-vous comme loueur',
    offerRentals: 'Proposez vos équipements en location',
    searchRental: 'Rechercher un équipement à louer...',
    perDay: '/jour',
    perWeek: '/sem.',
    perMonth: '/mois',
    // Profile Edit
